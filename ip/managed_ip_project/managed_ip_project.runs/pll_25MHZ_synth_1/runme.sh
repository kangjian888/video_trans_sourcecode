...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_source/ip/managed_ip_project/managed_ip_project.runs/pll_25MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_25MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_25MHZ.tcl
