...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_source/ip/managed_ip_project/managed_ip_project.runs/ex_rx_uart_tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_rx_uart_tx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex_rx_uart_tx_fifo.tcl
